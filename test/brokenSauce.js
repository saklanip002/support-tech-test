...
describe('Broken Sauce', function () {
    it('should go to Google and click Sauce', async function () {
        ...
        let resource_link = await driver.findElement(By.partialLinkText("Resources"));

        // let resources = await driver.findElement(function(){
        //     menus = driver.findElement(By.className("nav-menu-main-link has-sub-menu"));
        //     return promise.filter(menus, function(link){
        ...
        let resource = await resource_link.findElement(By.xpath(".."));
        await resource_link.click();

        let documententation = await driver.findElement(By.partialLinkText("Documentation"));
        await documententation.click();
